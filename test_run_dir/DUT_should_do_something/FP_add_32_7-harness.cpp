...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/mvega/Documents/git_imports/chisel_fp_generators/chiselfp/test_run_dir/DUT_should_do_something/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_in_en = u; break;
      case 2 : dut->io_in_valid = u; break;
      case 3 : dut->io_in_a = u; break;
      case 4 : dut->io_in_b = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_in_en; break;
      case 2 : value = dut->io_in_valid; break;
      case 3 : value = dut->io_in_a; break;
      case 4 : value = dut->io_in_b; break;
      case 5 : value = dut->io_out_s; break;
      case 6 : value = dut->io_out_valid; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/mvega/Documents/git_imports/chisel_fp_generators/chiselfp/test_run_dir/DUT_should_do_something/FP_add_32_7.vcd)";
